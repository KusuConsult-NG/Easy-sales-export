...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            {/* Hero Section */}
            <section className="py-20 bg-linear-to-br from-green-50 via-white to-green-100">
                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-slate-900">
                                <p>
                    ...
                    {/* Mission Statement */}
                    <div className="bg-emerald-50 border-l-4 border-emerald-600 p-8 rounded-r-xl mb-20">
                        <p className="text-lg italic text-slate-900 mb-4">
                    ...
                    <div className="mb-20">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={index} className="flex items-start gap-3 bg-white p-6 rounded-xl border border-slate-200">
                    ...
                    {/* WAVE Partnership */}
                    <div className="bg-linear-to-br from-green-50 to-green-100 rounded-3xl p-10 border border-green-200">
            ...
            {/* Tagline Section */}
            <section className="py-20 bg-linear-to-br from-slate-100 to-slate-50">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
                        Easy Sales Export Nigeria Limited
                    </h2>
                    <p className="text-xl text-slate-900 mb-3">
