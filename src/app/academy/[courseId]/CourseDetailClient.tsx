...
export default function CourseDetailClient(props: {
    ...
    courseId: string;
    /**
     *   The course and the member's progress, already fetched in parallel. Raw,
     *   because the effect below decides enrolment and lesson state from them.
     */
    initial?: { courseReq: any; progressReq: any } | null;
}) {
    ...
    useEffect(() => {
        ...
        async function fetchCourse() {
            ...
            try {
                const seed = takeSeed();
                const [courseReq, progressReq] = seed
