...
export default function LessonClient(props: {
    /**  #555 The ids as plain strings — the server page resolved the params. */
    courseId: string;
    lessonId: string;
    /**
     *   The three reads, already fetched in parallel. RAW: the client walks the
     *   course to find the current lesson and module, computes the next and
     *   previous lessons and merges the video progress — a substantial
     *   derivation that stays in one place.
     */
    initial?: { courseReq: any; progressReq: any; lessonProgressData: any } | null;
}) {
    //   #555 The server page resolved the params, so there is no promise to
    //   unwrap here any more.
    ...
    useEffect(() => {
        ...
        async function loadLessonData() {
            ...
            try {
                ...
                const seed = takeSeed();
                const [courseReq, progressReq, lessonProgressData] = seed
