...
import { Mail, Lock, AlertCircle, Eye, EyeOff, GraduationCap, CheckCircle, ArrowRight, Loader2 } from "lucide-react";
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative w-full max-w-md">
                <div className="text-center mb-6 md:mb-8 relative z-10">
                    <Link href="/academy" className="inline-flex items-center justify-center mb-4 md:mb-6 hover:opacity-90 transition-opacity">
                        <div className="w-12 h-12 md:w-16 md:h-16 bg-linear-to-br from-blue-600 to-indigo-700 rounded-2xl flex items-center justify-center shadow-xl shadow-blue-500/20 text-white transform rotate-3 hover:rotate-6 transition-transform">
                            <GraduationCap className="w-6 h-6 md:w-8 md:h-8" />
                        </div>
                    </Link>
                    <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2">Welcome Back</h1>
                    <p className="text-sm md:text-base text-slate-500 dark:text-slate-400">Sign in to your Academy account</p>
                </div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-2xl border border-slate-100 dark:border-slate-700 relative z-10 backdrop-blur-sm">
                    <form action={formAction} className="space-y-5 md:space-y-6">
                            ...
                            <label className="flex items-center gap-3 cursor-pointer group">
                                <div className="relative flex items-center">
                                    <input
                                        ...
                                        className="peer w-5 h-5 rounded-md border-2 border-slate-300 dark:border-slate-600 text-blue-600 focus:ring-blue-500/50 transition-all active:scale-95"
                                        disabled={isPending}
                                    />
                        ...
                        <LoadingButton
                            ...
                            className="w-full py-2.5 bg-linear-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all border-0 flex items-center justify-center gap-2"
                        >
                            Sign In
