...
export default function WithdrawPage() {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-50 to-green-50 py-12 px-4">
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                step="100"
                                required
                                className="w-full pl-12 pr-4 py-4 text-2xl font-semibold border-2 border-slate-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                            />
                        </div>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    maxLength={10}
                                    required
                                    className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 font-mono"
                                />
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 resize-none"
                        />
                    </div>
