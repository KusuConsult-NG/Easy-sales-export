/**
 * Export Windows Sidebar Navigation
 * 
 * Custom sidebar for Export module with Slate/Blue-Gray theme
 */
...
export default function ExportSidebar() {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-0 left-0 h-full w-64 bg-slate-900 border-r border-slate-800 transition-transform z-40 ${mobileMenuOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
                    }`}
            >
                {/* Header */}
                <div className="p-6 border-b border-slate-800">
                    ...
                    <Link href="/export" className="flex items-center gap-3 group">
                        ...
                        <div>
                            <h2 className="font-bold text-white text-lg">Export Windows</h2>
