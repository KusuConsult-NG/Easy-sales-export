...
export default function ExportBookingsClient({ initial = null }: {
    ...
    useEffect(() => {
        //   #546 Already supplied by the server. A failed server read passes
        //   null, and this falls through to the fetch exactly as before — so
        //   #307's "a failed list is not an empty one" still holds.
