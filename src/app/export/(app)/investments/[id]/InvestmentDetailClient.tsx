...
export default function InvestmentDetailClient({ investmentId, initial = null }: {
    /**
     *   #547 The id is a prop and the list arrives with it. The server page
     *   resolves the route param and does the read; the FIND stays here, so
     *   "not found" and "you don't have access" keep saying themselves.
     */
    investmentId: string;
