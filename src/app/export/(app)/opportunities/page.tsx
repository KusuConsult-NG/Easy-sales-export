...
export default function ExportWindowsPage() {
    const [windows, setWindows] = useState<ExportWindow[]>(() => [
        ...
        {
            id: "3",
            title: "Animal Husbandry Export - Middle East",
            commodity: "Livestock Products",
            targetVolume: 40000,
            currentVolume: 18000,
            slotPrice: 1500,
        ...
        {
            id: "4",
            title: "Fishery Export - Asian Markets",
            commodity: "Premium Seafood",
            targetVolume: 35000,
            currentVolume: 12500,
            slotPrice: 1800,
        ...
        {
            id: "5",
            title: "Poultry Export - West Africa",
            commodity: "Processed Poultry",
            targetVolume: 45000,
            currentVolume: 22000,
            slotPrice: 1100,
