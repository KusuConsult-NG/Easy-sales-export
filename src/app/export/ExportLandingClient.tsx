...
export default function ExportLandingClient({ initial = null }: {
    /**  #548 The three live windows the server already fetched, seeded into
     *   state so the landing page arrives with them. */
    initial?: any[] | null;
}) {
    ...
    const [liveWindows, setLiveWindows] = useState<any[]>(initial ?? []);
    const [windowsLoading, setWindowsLoading] = useState(initial === null);
