        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-6 md:mb-8 relative z-10">
                    <Link href="/export" className="inline-flex items-center justify-center mb-4 md:mb-6 hover:opacity-90 transition-opacity">
                        <div className="w-12 h-12 md:w-16 md:h-16 bg-linear-to-br from-orange-600 to-amber-700 rounded-2xl flex items-center justify-center shadow-xl shadow-orange-500/20 text-white transform rotate-3 hover:rotate-6 transition-transform">
                    ...
                    <p className="text-sm md:text-base text-slate-500 dark:text-slate-400">Sign in to your Export account</p>
                </div>
