...
function ExportRegisterContent() {
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-lg bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl relative z-10">
                {/* Header */}
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-2">Join Export Windows</h1>
                    <p className="text-slate-300">Start your export investment journey</p>
                </div>
                ...
                <form action={formAction} className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <User className="absolute left-3 top-3.5 w-5 h-5 text-slate-400 group-focus-within:text-slate-300 transition-colors" />
                                <input
                                    type="text"
                                    name="firstName"
                                    required
                    ...
                    <LoadingButton
                        ...
                        className="w-full bg-slate-100 hover:bg-white text-slate-900 font-bold py-3.5 rounded-xl shadow-lg shadow-white/5 transition-all hover:scale-[1.02] active:scale-[0.98] group"
                    >
                        Create Account
