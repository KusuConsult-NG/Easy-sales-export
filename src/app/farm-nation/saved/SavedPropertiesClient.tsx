 ...
 */
export default function SavedPropertiesClient({ initial = null }: {
    /**  #551 The saved properties the server already fetched. */
    initial?: SavedPropertyRecord[] | null;
}) {
    const [loading, setLoading] = useState(initial === null);
    const [error, setError] = useState<string | null>(null);
    const [properties, setProperties] = useState<SavedPropertyRecord[]>(initial ?? []);

    useEffect(() => {
        //   #551 Already supplied by the server; a failed read passes null.
