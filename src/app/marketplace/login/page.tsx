        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8 relative z-10">
                    <Link href="/marketplace" className="inline-flex items-center justify-center mb-6 hover:opacity-90 transition-opacity">
                        <div className="w-16 h-16 bg-linear-to-br from-green-600 to-emerald-700 rounded-2xl flex items-center justify-center shadow-xl shadow-green-500/20 text-white transform rotate-3 hover:rotate-6 transition-transform">
                            <Store className="w-8 h-8" />
                        </div>
                    </Link>
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Welcome Back</h1>
                    <p className="text-slate-500 dark:text-slate-400">Sign in to your Marketplace account</p>
                </div>
