...
export default function OrderConfirmationClient({ initial = null }: {
    /**
     *   #552 The order the server already fetched.
     *
     *   `loadOrder` stays: it is what redirects to /marketplace when the order
     *   is missing or is not the caller's, and a refusal passes null so that
     *   path still runs.
     */
    initial?: Order | null;
}) {
