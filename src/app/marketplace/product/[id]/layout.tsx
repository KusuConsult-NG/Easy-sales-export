...
/**
 * Dynamic metadata for marketplace product pages.
 * The page itself is a Client Component ("use client"), so metadata
 * must be exported from this layout file instead.
 */
export async function generateMetadata(
    ...
    try {
        const db = getAdminDb()
        const doc = await db.collection(COLLECTIONS.MARKETPLACE_PRODUCTS).doc(id).get()
        ...
        return {
            ...
            openGraph: {
                ...
                description,
                url: `https://easysalesexport.com/marketplace/product/${id}`,
        ...
        // Fallback: never break the page if metadata fetch fails
        return {
