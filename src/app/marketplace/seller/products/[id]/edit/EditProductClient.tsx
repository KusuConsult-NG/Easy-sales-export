...
type ProductSeed = Awaited<ReturnType<typeof getProductByIdAction>>;

export default function EditProductClient({ initial = null }: { initial?: ProductSeed | null }) {
    ...
    //   #560 — the server already read this product. Handed INTO the effect
    //   rather than into useState: the effect does substantial derived work —
    //   it decides whether the title is one of the preset options or a custom
    //   one, unpacks three pricing tiers into six pieces of state, and splits
    //   the unit the same way — and duplicating that on the server would be two
    //   copies of one contract. So this removes the round trip and not the
    //   spinner, exactly as #543 records for the buyer and seller dashboards.
