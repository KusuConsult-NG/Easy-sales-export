        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-12 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 lg:p-12 space-y-8">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">1. Categories of Personal Data Collected</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">2. Lawful Basis for Processing</h2>
                        <p className="text-slate-600 dark:text-slate-400">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">6. International Transfers</h2>
                        <p className="text-slate-600 dark:text-slate-400">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">7. Data Subject Rights</h2>
                        <p className="text-slate-600 dark:text-slate-400">
