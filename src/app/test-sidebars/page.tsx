            ...
            {!module && (
                <div className="p-10">
                    ...
                    <div className="flex flex-col gap-2">
                        <a href="/test-sidebars?module=wave" className="text-blue-500 hover:underline">Test WAVE Sidebar</a>
                        <a href="/test-sidebars?module=farm-nation" className="text-blue-500 hover:underline">Test Farm Nation Sidebar</a>
                        <a href="/test-sidebars?module=cooperative" className="text-blue-500 hover:underline">Test Cooperative Sidebar</a>
                        <a href="/test-sidebars?module=academy" className="text-blue-500 hover:underline">Test Academy Sidebar</a>
                        <a href="/test-sidebars?module=export" className="text-blue-500 hover:underline">Test Export Sidebar</a>
                    </div>
                </div>
            )}
        </div>
