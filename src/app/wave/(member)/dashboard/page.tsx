    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-emerald-50 via-emerald-50 to-emerald-50">
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="mt-8 bg-white rounded-3xl p-8 border border-gray-100 shadow-lg relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-slate-50 border border-slate-100 hover:bg-slate-100/80 rounded-2xl p-6 transition flex flex-col justify-between">
                                <div>
                                    <span className="text-[10px] px-2.5 py-1 bg-emerald-100 text-emerald-800 rounded-full font-bold uppercase tracking-wider">Marketplace</span>
                                    <h3 className="text-lg font-bold text-gray-900 mt-3 mb-1">Trade Products</h3>
                                ...
                                <button
                                    ...
                                    className="w-full py-2.5 bg-emerald-800 text-white font-semibold rounded-xl text-xs hover:bg-emerald-900 transition flex items-center justify-center gap-1.5"
                                >
                                    Open Marketplace
                            ...
                            <div className="bg-slate-50 border border-slate-100 hover:bg-slate-100/80 rounded-2xl p-6 transition flex flex-col justify-between">
                                <div>
                                    <span className="text-[10px] px-2.5 py-1 bg-blue-100 text-blue-800 rounded-full font-bold uppercase tracking-wider">Export Window</span>
                                    <h3 className="text-lg font-bold text-gray-900 mt-3 mb-1">Export Window</h3>
                                    <p className="text-xs text-gray-600 leading-relaxed mb-4">
                            ...
                            <div className="bg-slate-50 border border-slate-100 hover:bg-slate-100/80 rounded-2xl p-6 transition flex flex-col justify-between">
                                <div>
                                    <span className="text-[10px] px-2.5 py-1 bg-purple-100 text-purple-800 rounded-full font-bold uppercase tracking-wider">Farm Nation</span>
                                    <h3 className="text-lg font-bold text-gray-900 mt-3 mb-1">Farmland & Cultivation</h3>
                                    <p className="text-xs text-gray-600 leading-relaxed mb-4">
