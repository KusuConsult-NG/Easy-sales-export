...
export default function WaveLandingPage() {
    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="relative min-h-screen flex items-center justify-center bg-linear-to-br from-emerald-50 via-white to-purple-50 overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="relative max-w-7xl mx-auto px-6 py-20 text-center">
                    {/* Presidential Badge */}
                    <div className="inline-flex items-center gap-2 bg-linear-to-r from-emerald-600 to-green-700 text-white px-6 py-2 rounded-full text-sm font-semibold mb-8 shadow-lg">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold bg-linear-to-r from-emerald-600 to-purple-600 bg-clip-text text-transparent mb-6">
                    ...
                    <p className="text-xl md:text-2xl text-slate-700 max-w-4xl mx-auto mb-12">
                        ...
                        <span className="font-semibold text-emerald-600">A Women-Led Revolution in Agribusiness.</span>
                    </p>
            ...
            <section className="py-16 bg-linear-to-br from-emerald-50 via-purple-50 to-white">
                <div className="max-w-6xl mx-auto px-6">
                    <div className="text-center mb-8">
                        <h3 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3">
                            <span className="text-emerald-600">RH-WAVE 774</span> in Action
                        </h3>
                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
                            ...
                            <span className="text-emerald-600">A National Reawakening</span>
                        </h2>
                        <div className="w-24 h-1 bg-linear-to-r from-emerald-600 to-purple-600 mx-auto rounded-full" />
                    </div>

                    <div className="prose prose-lg max-w-4xl mx-auto text-slate-700 leading-relaxed">
                        <p className="text-xl mb-6">
                            RH-WAVE 774 is Nigeria's boldest answer to economic exclusion, food insecurity, and structural inequality — anchored on the <strong className="text-emerald-600">brilliance, courage, and economic power of Nigerian women</strong>.
                        </p>
            ...
            <section className="py-20 bg-linear-to-br from-emerald-50 to-purple-50">
                <div className="max-w-7xl mx-auto px-6">
                    {/* Vision Statement */}
                    <div className="bg-white rounded-3xl p-10 shadow-xl mb-16">
                        <div className="flex items-start gap-4 mb-4">
                            <Sparkles className="w-8 h-8 text-emerald-600 shrink-0 mt-1" />
                            <div>
                                <h3 className="text-2xl font-bold text-slate-900 mb-4">Our Vision</h3>
                                <p className="text-lg text-slate-700 leading-relaxed">
                                    A Nigeria where every woman is a <strong className="text-emerald-600">wealth creator</strong>, <strong className="text-purple-600">value-chain leader</strong>, <strong className="text-emerald-600">job generator</strong>, trusted participant in national export growth, and builder of resilient food systems.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                            <div className="text-6xl font-bold text-emerald-600 mb-4">70%</div>
                    ...
                    <div className="text-center mt-12">
                        <Link
                            href="/wave/application"
                            className="inline-flex items-center gap-3 bg-linear-to-r from-emerald-600 to-green-700 text-white px-8 py-4 rounded-xl text-lg font-bold shadow-xl hover:shadow-emerald-500/50 transition-all hover:scale-105"
                        >
            ...
            <section className="py-20 bg-slate-50">
                <div className="max-w-6xl mx-auto px-6">
                    <h2 className="text-4xl md:text-5xl font-bold text-center text-slate-900 mb-16">
                        Our Genesis — <span className="text-emerald-600">Hope Birthed from National Purpose</span>
                    </h2>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="bg-slate-50 rounded-2xl p-8">
                            ...
                            <p className="text-lg text-slate-700 leading-relaxed mt-4">
                                This stark imbalance has constrained productivity, deepened poverty, and weakened national food systems. <strong className="text-emerald-600">RH-WAVE 774 was born to change that.</strong>
                            </p>
                            <p className="text-lg text-slate-700 leading-relaxed mt-4">
                                Under the <strong>Renewed Hope Agenda</strong>, President Tinubu empowered the Federal Ministry of Women Affairs to architect a program that <strong className="text-purple-600">dismantles barriers — not just talk about them</strong>.
                            </p>
                        </div>

                        {/* OIC Partnership */}
                        <div className="bg-linear-to-br from-emerald-50 to-green-50 rounded-2xl p-8 border-l-4 border-emerald-600">
                        ...
                        <div className="bg-linear-to-br from-purple-50 to-blue-50 rounded-2xl p-8 border-l-4 border-purple-600">
                            <h3 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                            The program is built on <strong className="text-emerald-600">5 pillars of transformation</strong>
                        </p>
                    </div>
                    ...
                    <div className="bg-linear-to-r from-emerald-600 to-purple-600 rounded-3xl p-1 max-w-4xl mx-auto">
                        <div className="bg-white rounded-3xl p-8 text-center">
                            <p className="text-2xl font-bold text-slate-900">
                                This is not charity — this is <span className="text-emerald-600">structured economic participation</span>.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-16 bg-white rounded-3xl p-10 shadow-xl">
                        <h3 className="text-3xl font-bold text-center text-slate-900 mb-8">
                            To Every Nigerian Woman — <span className="text-emerald-600">This is Your Moment</span>
                        </h3>
                        ...
                        <div className="grid md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                            {[
                                ...
                                <div key={index} className="bg-emerald-50 rounded-lg p-4 text-center">
                                    <p className="font-semibold text-emerald-700">{type}</p>
                                </div>
                            ))}
                        </div>
                        ...
                        <p className="text-lg text-center text-emerald-600 mt-4">
            ...
            <section className="py-20 bg-slate-50">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="w-24 h-1 bg-linear-to-r from-emerald-600 to-purple-600 mx-auto rounded-full mb-16" />
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-16">
                        {[
                            ...
                            <div key={index} className="bg-linear-to-br from-emerald-50 to-green-50 rounded-2xl p-8 border-l-4 border-emerald-600">
                    ...
                    {/* What You Gain */}
                    <div className="bg-linear-to-br from-purple-50 to-blue-50 rounded-3xl p-10">
                    ...
                    <div className="mt-16 text-center">
                        ...
                        <p className="text-lg text-slate-700 mb-8 max-w-3xl mx-auto">
                            ...
                            <span className="font-semibold text-emerald-600">Women building nations.</span>
                        </p>
            ...
            <section className="py-20 bg-linear-to-br from-emerald-600 to-green-700 text-white">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <Link
                        href="/wave/application"
                        className="inline-flex items-center gap-3 bg-white text-emerald-700 px-12 py-6 rounded-xl text-xl font-bold shadow-2xl hover:shadow-white/50 transition-all hover:scale-105"
                    >
