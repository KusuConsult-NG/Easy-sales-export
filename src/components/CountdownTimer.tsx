    ...
    if (timeRemaining.expired) {
        return (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                <p className="text-red-800 font-semibold">Window Expired</p>
            </div>
        );
    }
        ...
        <div className="bg-linear-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-4 gap-4">
                <div className="text-center">
                    ...
                    <p className="text-xs text-blue-700 mt-2">Days</p>
                </div>
                ...
                <div className="text-center">
                    ...
                    <p className="text-xs text-blue-700 mt-2">Hours</p>
                </div>
                ...
                <div className="text-center">
                    ...
                    <p className="text-xs text-blue-700 mt-2">Seconds</p>
                </div>
            </div>
        </div>
    );
