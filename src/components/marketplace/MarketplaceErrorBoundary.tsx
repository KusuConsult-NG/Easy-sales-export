 ...
 * Handles STALE_DATA errors with a user-friendly "Refresh & Retry" prompt.
 */
    ...
    componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
        ...
        if (isStaleDeploymentError(error)) {
            if (consumeReloadBudget()) {
                console.warn('[MarketplaceErrorBoundary] Stale deployment — reloading once.');
                window.location.reload();
                return;
            }
            console.error(
                '[MarketplaceErrorBoundary] Stale deployment error after this page already used its '
        ...
        if (!error.message.startsWith('NEXT_REDIRECT')) {
            reportBoundaryError(error, "component/MarketplaceErrorBoundary", errorInfo);
        }
    }
                    ...
                    <div className="min-h-[400px] flex items-center justify-center p-6 bg-amber-50/30 rounded-2xl border border-amber-100 backdrop-blur-sm">
                        <div className="max-w-md w-full text-center">
                            ...
                            <p className="text-gray-600 mb-8">
                                Someone else updated this information while you were viewing it. To prevent overwriting their changes, please refresh the page.
                            </p>
            ...
            return (
                <div className="min-h-[400px] flex items-center justify-center p-6 bg-red-50/30 rounded-2xl border border-red-100 backdrop-blur-sm">
                    <div className="max-w-md w-full text-center">
                        ...
                        <p className="text-gray-600 mb-8">
                            We hit a snag loading the marketplace. Don't worry, your data is safe.
                        </p>
