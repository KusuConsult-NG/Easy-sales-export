...
async function check() {
  ...
  // Let's just find ANY users that have a cooperativeId but are not marked as completed in cooperative_members
  ...
  for (const doc of snap.docs) {
      ...
      // If a user has a cooperativeId, they clicked 'Join' 
